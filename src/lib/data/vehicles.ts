...
export const vehicleData: Record<string, VehicleData> = {
  ...
  "renault-master": {
    name: "RENAULT MASTER",
    tagline: "The Efficient Fleet Favourite.",
    description: "The Renault Master (also sold as the Nissan Interstar and older Vauxhall Movano) is a staple of UK delivery fleets. While it lacks the premium feel of the German vans or the extreme width of the Sevel chassis, its lightweight construction and efficient engines make it a practical, budget-friendly foundation for simpler builds.",
    heroImage: "/images/bespoke-master.png",
    schematicImage: "/images/renault-master-schematic.png",
    specs: [
      { label: "Engine Options", value: "2.3L dCi" },
      { label: "Power Output", value: "110 - 180", unit: "HP" },
      { label: "Drivetrain", value: "FWD / RWD" },
      { label: "Transmission", value: "6-Speed Manual / AMT" },
      { label: "GVWR", value: "2800 - 4500", unit: "KG" },
    ],
    configurations: [
      { label: "L2H2 (Medium)", length: "5548mm", internalL: "3083mm", height: "H2 High", volume: "10.8m³" },
      { label: "L3H2 (Long)", length: "6198mm", internalL: "3733mm", height: "H2 High", volume: "13.0m³" },
      { label: "L4H3 (XLWB)", length: "6848mm", internalL: "4383mm", height: "H3 Super", volume: "17.0m³" },
    ],
    pros: ["Very high fuel efficiency", "Competitive used pricing", "Reliable 2.3L chain-driven engine", "Low floor height (FWD)"],
    cons: ["Narrower than Ducato/Sprinter", "Less refined interior plastics", "AMT 'Quickshift' gearbox is poor", "Lower resale value"],
    bestFor: "Budget-conscious builders looking for a newer van with lower running costs.",
    watchOutFor: "Avoid the Quickshift semi-auto gearbox if possible; the manual is far more reliable.",
    manufacturerUrl: "https://www.renault.co.uk/vans/master.html",
    ebaySearch: "https://www.ebay.co.uk/sch/i.html?_nkw=renault+master+panel+van+lwb",
    autotraderSearch: "https://www.autotrader.co.uk/van-search?make=Renault&model=Master",
    fbSearch: "https://www.facebook.com/marketplace/category/vehicles",
    internalWidth: "1.76m",
    wheelbase: 3.682,
    gvm: 3500,
