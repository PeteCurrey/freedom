...
export const PRODUCTS: Product[] = [
  ...
  // --- MAXXAIR VENTILATION ---
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'intermediate',
    installStage: 'Stage 2: Windows & ventilation',
    payloadWeightKg: 6.0,
  ...
  // --- FIAMMA EXTERIOR ---
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'advanced',
    installStage: 'Stage 8: Exterior finishing',
  ...
  // --- WHALE WATER & AIR HEATING ---
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'advanced',
    installStage: 'Stage 5: Plumbing & water',
    payloadWeightKg: 4.5,
  ...
  // --- DODO MAT INSULATION ---
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'beginner',
    installStage: 'Stage 1: Sound deadening',
    payloadWeightKg: 4.0,
  ...
  },
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'beginner',
    installStage: 'Stage 3: Thermal insulation',
    payloadWeightKg: 2.5,
  ...
  // --- ALPICOOL REFRIGERATION ---
  {
    ...
    compatibleBuildTypes: ['all'],
    installDifficulty: 'beginner',
    installStage: 'Stage 7: Kitchen & appliances',
    payloadWeightKg: 9.0,
