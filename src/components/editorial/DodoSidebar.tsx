...
const DODO_PAGES = [
  { name: "Dodo Mat Brand Hub", href: "/brands/dodo-mat" },
  { name: "Van Insulation Guide", href: "/guides/dodo-mat/van-insulation-guide" },
  { name: "Insulation Installation", href: "/guides/dodo-mat/insulation-installation" },
];

export function DodoSidebar({ items, currentPage }: DodoSidebarProps) {
