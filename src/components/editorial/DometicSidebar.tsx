...
interface DometicSidebarProps {
  items: TocItem[];
  currentPage: string;
}

const DOMETIC_PAGES = [
  { name: "Dometic Brand Hub", href: "/brands/dometic" },
  { name: "CFX3 Fridge Review", href: "/guides/dometic/cfx3-review" },
  { name: "S4 Window Installation", href: "/guides/dometic/s4-window-installation" },
  { name: "Best Compressor Fridges", href: "/guides/compare/best-compressor-fridge-van" },
];

export function DometicSidebar({ items, currentPage }: DometicSidebarProps) {
