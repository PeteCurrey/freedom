...
interface WebastoSidebarProps {
  items: TocItem[];
  currentPage: string;
}

const WEBASTO_PAGES = [
  { name: "Webasto Brand Hub", href: "/brands/webasto" },
  { name: "Air Top Evo Guide", href: "/guides/webasto/air-top-evo-guide" },
  { name: "Air Top Installation", href: "/guides/webasto/air-top-installation" },
  { name: "Thermo Top Guide", href: "/guides/webasto/thermo-top-guide" },
  { name: "Webasto vs Truma", href: "/guides/compare/truma-vs-webasto" },
];

export function WebastoSidebar({ items, currentPage }: WebastoSidebarProps) {
