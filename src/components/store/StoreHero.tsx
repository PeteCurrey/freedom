    ...
    <section className="relative w-full flex items-center h-screen bg-brand-obsidian overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          ...
          priority
        />
        {/* Overlays for dark aesthetics and text readability */}
        <div className="absolute inset-0 bg-gradient-to-r from-brand-obsidian via-brand-obsidian/85 to-transparent z-10" />
        <div className="absolute inset-0 bg-brand-obsidian/45 z-10" />
        <div className="absolute inset-0 blueprint-grid opacity-10 z-10" />
      </div>

      <div className="container mx-auto px-6 relative z-20 pt-28 lg:pt-36 pb-16 h-full flex flex-col justify-center">
