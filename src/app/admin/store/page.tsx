    ...
    <div className="p-8">
      ...
      <div className="mb-12 flex flex-col md:flex-row justify-between items-end gap-6">
        ...
        <div className="flex gap-4">
          <Link href="/admin/store/kits" className="px-6 py-4 bg-brand-carbon text-brand-orange border border-brand-orange/30 font-mono text-[10px] uppercase tracking-widest hover:border-brand-orange transition-all flex items-center gap-2">
             <Briefcase size={14} /> Manage Build Kits
          </Link>
