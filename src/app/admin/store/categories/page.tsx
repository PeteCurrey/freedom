             ...
             <div className="divide-y divide-brand-border/50">
               {categories.map((cat) => (
                 <div key={cat.id} className="p-6 flex items-center justify-between group hover:bg-brand-obsidian transition-colors">
                   <div>
                     <span className="block font-display text-xl uppercase text-brand-white mb-1">{cat.name}</span>
             ...
             <div className="space-y-6">
                <div>
                   ...
                   <input 
                     ...
                     className="w-full bg-brand-obsidian border border-brand-border p-4 font-sans text-sm text-brand-white focus:border-brand-orange outline-none transition-colors"
                ...
                <div>
                   ...
                   <textarea 
                     ...
                     className="w-full bg-brand-obsidian border border-brand-border p-4 font-sans text-sm text-brand-white focus:border-brand-orange outline-none transition-colors min-h-[100px]"
                ...
                <button 
                  ...
                  className="w-full py-4 bg-brand-orange text-brand-white font-mono text-[10px] uppercase tracking-widest hover:bg-white hover:text-brand-orange transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
