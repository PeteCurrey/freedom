...
export default function EditProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const handleSave = async () => {
    ...
    if (!error) {
       ...
       alert("Failed to update product. Check the console.");
    }
  };
        ...
        <div className="lg:col-span-1 space-y-8">
           <div className="blueprint-border bg-brand-carbon p-8 top-32 sticky">
             ...
             <div className="space-y-4">
                <div className="aspect-square bg-brand-obsidian border border-brand-border overflow-hidden relative group">
                   {product.image_url ? (
