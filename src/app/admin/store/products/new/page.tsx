...
export default function NewProductPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      if (cats && cats.length > 0) {
        setProduct((prev: any) => ({ ...prev, category_id: cats[0].id }));
      }
    }
    fetchData();
  }, []);
  ...
  const handleSave = async () => {
    ...
    const result = await createProductAction(newProductData);
             ...
             <div className="space-y-4">
                ...
                <div className="space-y-3">
                   {product.images.map((img: string, idx: number) => (
                      <div key={idx} className="flex gap-2">
                        <input 
                          ...
                          className="flex-1 bg-brand-obsidian border border-brand-border p-3 font-mono text-[10px] text-brand-grey focus:border-brand-orange outline-none"
                   ...
                   <button 
                    ...
                    className="w-full py-2 border border-dashed border-brand-border text-brand-grey font-mono text-[9px] uppercase tracking-widest hover:border-brand-orange hover:text-brand-orange transition-all flex items-center justify-center gap-2"
                   >
             ...
             <label className="flex items-center gap-4 cursor-pointer mb-6">
              ...
              <div className="pt-8 border-t border-brand-border mt-8">
                 ...
                 <label className="flex items-center gap-4 cursor-pointer mb-6">
                    <input 
                      type="checkbox" 
                      checked={product.is_editor_pick || false}
              ...
              <div className="pt-8 border-t border-brand-border mt-8">
                 ...
                 <label className="flex items-center gap-4 cursor-pointer mb-6">
                    <input 
                      type="checkbox" 
                      checked={product.video_enabled || false}
                 ...
                 {product.video_enabled && (
                    <div className="space-y-6 pt-4 animate-in fade-in slide-in-from-top-2">
                       <div className="space-y-2">
                          ...
                          <select 
                            value={product.video_source || "youtube"}
