...
export default function SuppliersManagerPage() {
  ...
  const autoSeed = async () => {
    ...
    const presetSuppliers = [
      ...
      { name: 'Callidus Trade', website: 'https://callidus.shop', status: 'potential', categories: ['electrical', 'solar'], description: 'Victron full range, solar panels, batteries. Devon-based. 01626 563563' },
      { name: 'Energy Monkey', website: 'https://energymonkey.co.uk', status: 'potential', categories: ['electrical', 'solar', 'batteries'], description: 'Victron specialist, off-grid systems, LiFePO4. Gloucestershire. 01452 699300. Family-run, excellent technical support.' },
      { name: 'Midsummer Energy', website: 'https://midsummerenergy.co.uk', status: 'potential', categories: ['electrical', 'solar'], description: 'Victron, solar panels, charge controllers, mounting. Cambridge-based. Strong on solar panels.' },
      ...
      { name: '12 Volt Planet', website: 'https://12voltplanet.co.uk', status: 'potential', categories: ['electrical', 'components'], description: '12V components — fuse boxes, switches, cable, terminals, connectors. Essential for all the small components.' },
      { name: 'Bimble Solar', website: 'https://bimblesolar.com', status: 'potential', categories: ['electrical', 'solar'], description: 'Solar panels, MPPT controllers, cables, connectors, mounting kits. UK-based solar specialist.' },
      { name: 'Alpha Batteries', website: 'https://alpha-batteries.co.uk', status: 'potential', categories: ['electrical', 'batteries', 'kits'], description: 'Victron kits, leisure batteries, chargers, solar kits. Stock complete Victron off-grid conversion kits.' },
      { name: 'Butler Technik', website: 'https://butlertechnik.com', status: 'potential', categories: ['electrical', 'kits'], description: 'Victron power upgrade kits, batteries, inverters. Specialise in pre-configured Victron kits.' },
      { name: 'Jacksons Leisure', website: 'https://jacksonsleisure.com', status: 'potential', categories: ['heating', 'water', 'leisure'], description: 'Truma (Combi, VarioHeat), Propex, Webasto. Stock complete Truma Combi kits with all ducting.' },
      { name: 'PB Auto Electrics', website: 'https://pbautoelectrics.co.uk', status: 'potential', categories: ['heating', 'electrical'], description: 'Webasto, Eberspächer, Truma — heaters, parts, service kits. Specialist in vehicle heating.' },
      ...
      { name: 'Nomadic Leisure', website: 'https://nomadicleisure.co.uk', status: 'potential', categories: ['heating', 'kits'], description: 'Truma complete kits, Webasto, ducting, controllers. Good pre-packaged Truma installation kits.' },
      { name: 'CAK Tanks', website: 'https://caktanks.co.uk', status: 'potential', categories: ['water', 'plumbing', 'tanks'], description: 'Water tanks (custom + off-the-shelf), SMEV sinks, pumps, taps, plumbing fittings. Specialist in tanks.' },
      ...
      { name: 'Leisurelines', website: 'https://leisurelines.co.uk', status: 'potential', categories: ['water', 'plumbing', 'tanks'], description: 'Water tanks, pumps, taps, waste systems, shower trays. Good range of purpose-built campervan tanks.' },
      ...
      { name: 'Grassroutes Leisure', website: 'https://grassroutesleisure.co.uk', status: 'potential', categories: ['furniture', 'materials', 'ply'], description: 'Vöhringer lightweight ply, furniture materials. UK\'s main Vöhringer distributor. Used by professional converters.' },
      { name: 'Premier Forest (Superva)', website: 'https://premierforest.co.uk', status: 'potential', categories: ['furniture', 'materials', 'ply', 'cnc'], description: 'Superva lightweight laminated ply panels. CNC cutting + edge banding service. Used by pro converters.' },
      { name: 'Panel Company', website: 'https://panelcompany.co.uk', status: 'potential', categories: ['furniture', 'cladding', 'pvcp'], description: 'PVC wall panels, waterproof cladding, wood-effect panels. Good for wet room/shower areas.' },
      { name: 'Wickes / Homebase', website: 'https://wickes.co.uk', status: 'potential', categories: ['furniture', 'cladding', 'timber'], description: 'Tongue & groove spruce cladding, birch ply, general timber. Budget option for wall cladding.' },
      { name: 'Robbins Timber', website: 'https://robbinstimber.co.uk', status: 'potential', categories: ['furniture', 'materials', 'timber'], description: 'Birch plywood (all grades), marine ply, hardwoods, veneers. Bristol-based.' },
      { name: 'Wholesale Van Accessories', website: 'https://wholesalevanaccessories.co.uk', status: 'potential', categories: ['windows', 'hardware'], description: 'Conversion windows (trade supply), bonded windows, rubber seal windows. Supply windows to biggest UK converters.' },
      { name: 'Kiravans', website: 'https://kiravans.co.uk', status: 'potential', categories: ['windows', 'hardware', 'accessories'], description: 'Barn door windows, tailgate windows, bonded glass, privacy glass. Innovators — designed original T5/T6 barn door window.' },
      ...
      { name: 'Transporter HQ', website: 'https://transporterhq.co.uk', status: 'potential', categories: ['wheels', 'externals', 'styling'], description: 'VW T5/T6 alloy wheels, styling, bumpers, lights, accessories. VW Transporter specialist.' },
      ...
      { name: 'Ring Automotive', website: 'https://ringautomotive.com', status: 'potential', categories: ['tech', 'electrical'], description: '12V inverters, compressors, battery chargers, work lights. Available through motor factors.' },
      { name: 'UK Leisure Parts', website: 'https://ukleisureparts.co.uk', status: 'potential', categories: ['general', 'wholesale'], description: 'Reimo (roofs, furniture), Dometic, Fiamma, Truma, Thetford, Thule. 350+ trade customers.' },
      { name: 'Van Conversion Shop', website: 'https://vanconversionshop.co.uk', status: 'potential', categories: ['general', 'kits'], description: 'Wide range — electrical, plumbing, heating, insulation, furniture, windows.' },
      { name: 'Seaside Campers', website: 'https://seasidecampers.co.uk', status: 'potential', categories: ['general', 'bundles'], description: 'Dodo insulation kits, Dometic, electrical, plumbing bundles.' },
      ...
      { name: 'Miriad Quest Leisure (MQL)', website: 'https://mql.co.uk', status: 'potential', categories: ['wholesale', 'trade-only'], description: 'Trade-ONLY. 40+ years. All major brands. Catalogues available.' },
      { name: 'LKQ Nova Leisure', website: 'https://novaleisure.com', status: 'potential', categories: ['wholesale'], description: 'Major UK leisure distributor. Credit + cash trade accounts.' },
