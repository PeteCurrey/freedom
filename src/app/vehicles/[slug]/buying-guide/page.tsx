...
export default function BuyingGuide() {
  ...
  const vehicle = vehicleData[slug as string] || vehicleData["mercedes-sprinter"];
  const prices = getPriceBrackets(slug as string);
  const specificChecks = getVehicleSpecificChecks(slug as string);
    ...
    <main className="bg-brand-obsidian min-h-screen">
      ...
      <section className="py-24 border-y border-brand-border/30">
        <div className="container mx-auto px-6">
          <h2 className="font-display text-4xl mb-16 uppercase">Ideal <span className="text-brand-orange">Specifications</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="blueprint-border p-10 bg-brand-carbon">
              <History className="w-8 h-8 text-brand-orange mb-6" />
              <h3 className="font-display text-xl mb-4 uppercase">Year Range</h3>
            ...
            <div className="blueprint-border p-10 bg-brand-carbon">
              ...
              <h3 className="font-display text-xl mb-4 uppercase">Must-Have Options</h3>
      ...
      <section className="py-32 bg-brand-carbon/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <h2 className="font-display text-4xl mb-6 uppercase">UK MARKET <span className="text-brand-orange">PRICING 2026</span></h2>
          ...
          <div className="blueprint-border overflow-hidden">
            <table className="w-full text-left border-collapse">
              <thead className="bg-brand-carbon border-b border-brand-border">
                <tr>
                  <th className="p-6 font-mono text-[10px] uppercase text-brand-grey tracking-widest text-brand-orange">Age Range</th>
      ...
      <section className="py-32">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div>
              <h2 className="font-display text-4xl mb-8 uppercase">Inspection <span className="text-brand-orange">Checklist</span></h2>
              ...
              <div className="space-y-12">
                {specificChecks.map((check, i) => (
                  <div key={i} className="flex gap-6 group">
                    ...
                    <div>
                      <h3 className="font-display text-xl mb-2 uppercase">{check.title}</h3>
      ...
      <section className="py-24 bg-brand-carbon border-y border-brand-border/30">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             <a href={vehicle.ebaySearch} target="_blank" className="blueprint-border p-10 bg-brand-obsidian group hover:border-brand-orange transition-all h-full flex flex-col justify-between italic">
             ...
             <a href={vehicle.autotraderSearch} target="_blank" className="blueprint-border p-10 bg-brand-obsidian group hover:border-brand-orange transition-all h-full flex flex-col justify-between italic">
                <Search className="w-8 h-8 text-brand-orange mb-8" />
                <div>
             ...
             <a href="https://www.facebook.com/marketplace/category/vehicles" target="_blank" className="blueprint-border p-10 bg-brand-obsidian group hover:border-brand-orange transition-all h-full flex flex-col justify-between italic">
                <Search className="w-8 h-8 text-brand-orange mb-8" />
                <div>
      ...
      <section className="py-32">
         <div className="container mx-auto px-6 text-center">
            <h2 className="font-display text-5xl lg:text-7xl mb-12 uppercase italic underline whitespace-nowrap overflow-hidden text-ellipsis">FOUND YOUR VAN? <span className="text-brand-orange">START PLANNING</span></h2>
            <Link 
              href="/planner" 
