...
export default function CartPage() {
  ...
  return (
    <main className="bg-white min-h-screen text-[#111111] pb-32">
      <Navbar />
      ...
      <section className="pt-24">
        <div className="container mx-auto px-6">
          ...
          {cartItems.length === 0 ? (
            /* Empty State */
            <div className="py-32 text-center bg-[#F8F8F6] border border-[#E5E5E5] relative overflow-hidden max-w-4xl mx-auto rounded-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-8 space-y-4">
                    ...
                    <div className="flex items-center gap-8 md:gap-12 shrink-0 w-full md:w-auto justify-between md:justify-end">
                       <div className="flex items-center border border-[#E5E5E5] h-10 rounded-sm">
                          <button
                            ...
                            className="w-10 h-full flex items-center justify-center hover:bg-[#F8F8F6] text-[#666666] hover:text-[#111111] transition-all"
                          >
                            <Minus size={12} />
                          </button>
                          <div className="w-10 h-full flex items-center justify-center font-display text-sm border-x border-[#E5E5E5] text-[#111111]">
                            {item.quantity}
                          </div>
                          <button
                            onClick={() => updateQuantity(item.id, 1)}
                       ...
                       <button
                        ...
                        className="text-[#999999] hover:text-brand-orange transition-colors p-2"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
                ...
                <div className="pt-8">
                  <Link
                    href="/store"
                    className="group inline-flex items-center gap-4 font-mono text-[10px] uppercase tracking-[0.2em] text-[#666666] hover:text-brand-orange transition-all"
                  >
              ...
              <div className="lg:col-span-4">
                <div className="bg-[#F8F8F6] border border-[#E5E5E5] p-8 sticky top-32 rounded-xl">
                  ...
                  <div className="space-y-4 font-sans text-sm mb-8 border-b border-[#E5E5E5] pb-8">
                    ...
                    <div className="flex justify-between text-[#666666]">
                      <span>Delivery</span>
                      <span>{subtotal > 15000 ? "Free UK Delivery" : "Calculated at checkout"}</span>
                    </div>
                  </div>
                  ...
                  <div className="mb-8">
                    <div className="flex gap-2 relative">
                      <input
                        ...
                        className="flex-1 bg-white border border-[#E5E5E5] px-4 py-3 text-sm focus:outline-none focus:border-brand-orange transition-colors font-mono uppercase text-[#111111]"
                      />
                      <button
                        onClick={applyPromo}
                        className="bg-[#E5E5E5] text-[#111111] px-4 py-3 font-display text-[10px] uppercase tracking-widest hover:bg-[#D5D5D5] transition-all font-bold"
                      >
                        Apply
                      </button>
                    </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-brand-orange text-white py-5 font-display text-xs uppercase tracking-[0.2em] hover:bg-[#E05A00] transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-md font-bold rounded-sm"
                  >
                    {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : "Proceed to Checkout"} <ArrowRight className="w-4 h-4" />
                  </button>

                  <p className="text-center font-mono text-[9px] text-[#999999] uppercase mt-6 tracking-widest">
                    Secure 256-bit AES encrypted checkout
                  </p>
                </div>
              </div>
            </div>
