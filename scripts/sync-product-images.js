...
const PRODUCT_DATA = {
  ...
  "maxxair-maxxfan-deluxe": [
    'https://www.maxxair.com/cdn/shop/products/00-07500K_main.jpg'
  ],
  ...
  "truma-combi-d4-e": [
    'https://www.truma.com/media/product-images/combi-d-4-e/truma-combi-d-4-e_main.jpg'
  ],
  "truma-aventa-comfort": [
    'https://www.truma.com/media/product-images/aventa-comfort/truma-aventa-comfort_main.jpg'
  ],
  ...
  "truma-combi-4e-kit": [
    'https://www.truma.com/media/product-images/combi-4-e/truma-combi-4-e_main.jpg'
  ]
};

const GENERATED_KITS = [
  { slug: "full-autonomy-electrical-kit", filename: "full_autonomy_electrical_kit_1778157754203.png" },
  { slug: "four-season-climate-kit", filename: "four_season_climate_kit_1778157784199.png" },
  { slug: "premium-wetroom-kit", filename: "premium_wetroom_kit_1778158042908.png" }
];

async function uploadKitImages() {
  console.log('Uploading generated kit images...');
  for (const kit of GENERATED_KITS) {
    const filePath = path.join(__dirname, '..', kit.filename);
...
async function updateAllProducts() {
  ...
  console.log('\nUpdating product image arrays in database...');
