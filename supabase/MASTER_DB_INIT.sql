...
(
  ...
  'Full-spec expedition build for the Highlands.', '/images/sprinter-hd.png',
  '{"Solar": "400W", "Battery": "300Ah Lithium"}', 2024, true, 5.0
),
(
  'scandi-ghost', 'Scandi Ghost', '@NorthernVans', 'VW Crafter MWB', 'VW Crafter',
  'Minimalist interior focus.', '/images/vw-crafter-expedition.png',
  '{"Solar": "200W", "Battery": "200Ah Lithium"}', 2023, false, 4.9
)
ON CONFLICT (slug) DO NOTHING;
